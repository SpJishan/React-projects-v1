  ...
  return (
    ...
    <div style={{
      ...
      <div className="randomColor">
        ...
        <button onClick={ typeOfColor === "rgb" ? createRandomRGBColor : createRandomHexColor}>Generate Random Color</button>
      </div>
      <div
        style={{
          display: "flex",
      ...
      >
        <h3>{typeOfColor === "rgb" ? "RGB Color Selected" : "HEX Color Selected"}</h3>
        <h1>{color}</h1>
      </div>
    </div>
    </div>
